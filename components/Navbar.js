...
export default function Navbar() {
  ...
  const { title } = navbar;
  return (
    <nav className="flex h-[75px] px-6 md:px-16 justify-between items-center w-full bg-white dark:bg-black">
      <span className="colorful text-sm font-extrabold">{title}</span>
      <a
